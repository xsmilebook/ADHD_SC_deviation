...
if (! dir.exists(paste0(interfileFolder, "/deviationdevelopmentTD"))){
  dir.create(paste0(interfileFolder, "/deviationdevelopmentTD"))
}


saveRDS(gamresult, paste0(interfileFolder, '/deviationdevelopmentTD/gamresult_', x,'.rds'))
